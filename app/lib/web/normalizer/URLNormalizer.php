...
class URLNormalizer {
    ...
    public function normalize($with_fragment = false) {
        if ( $this->path ) { 
            # case normalization
        ...
        return $this->scheme . $this->host . ($this->port ? ":" . $this->port : "") . $this->user . $this->pass . $this->path . $query . ($with_fragment ? $fragment : "");
    }
