...
if (isset($token[0]['access_token'])) {
	...
	$user_profile_data = array(
		...
		"education" => $education,
		//TODO code the logic for getting from facebook the highest education pursued by the user or find by ourselves
	...
	if ($friends) {
		...
		foreach($friends as $value){
			...
			$friend_education = isset($friend_profile['education']) ? json_encode($friend_profile['education']):'';
